...
<div class="car-wrapper">
  <div class="control-panel">
    <button class="icon start-engine-button" id="start-car-${id}">A</button>
    <button class="icon stop=engine-button" id="stop-car--${id}">B</button>
  </div>
